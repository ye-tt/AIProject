...
def build_argument_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Ingest text files into the knowledge base."
    )
    parser.add_argument(
        "--source",
        type=Path,
    ...
    parser.add_argument(
        "--chunk-size", type=int, default=300, help="Number of words per chunk."
    )
    parser.add_argument(
        "--chunk-overlap", type=int, default=50, help="Overlap in words between chunks."
    )
    return parser
